...
Lifting Convolution — Maps input from Z² to group space G × Z²
Group Convolutions — Preserves equivariance through the network
Group Pooling — Converts equivariant → invariant features for bit prediction
Supported groups:
...
escnn: E(2)-Equivariant Steerable CNNs
📝 Citation
...
🙏 Acknowledgments
Meta AI Research for the VideoSeal framework
QUVA Lab for the escnn library
